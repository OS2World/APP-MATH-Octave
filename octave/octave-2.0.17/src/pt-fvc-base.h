...
public:
  ...
  virtual void mark_fcn_file_up_to_date (double);

  virtual time_t time_parsed (void);

  virtual double time_checked (void);

  virtual bool is_builtin (void) const
    { return false; }
  ...
  virtual string_vector unload_fcn (void) { return string_vector (); }
