...
extract_tm (Octave_map &m, double& fraction)
{
  ...
  tm.tm_sec = (int) (m ["sec"] . double_value ());
  tm.tm_min = (int) (m ["min"] . double_value ());
  tm.tm_hour = (int) (m ["hour"] . double_value ());
  tm.tm_mday = (int) (m ["mday"] . double_value ());
  tm.tm_mon = (int) (m ["mon"] . double_value ());
  tm.tm_year = (int) (m ["year"] . double_value ());
  tm.tm_wday = (int) (m ["wday"] . double_value ());
  tm.tm_yday = (int) (m ["yday"] . double_value ());
  tm.tm_isdst = (int) (m ["isdst"] . double_value ());
