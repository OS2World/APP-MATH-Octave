...
#define DEFCONST(name, defn, doc) \
  DEFVAR_INT (#name, SBV_ ## name, defn, 1, 0, 0, doc); \
  DEFVAR_INT ("__" ## #name ## "__", XSBV_ ## name, defn, 0, 1, 0, doc)
...
#define DEFCONSTX(name, sname, defn, doc) \
  DEFVAR_INT (name, sname, defn, 1, 0, 0, doc); \
  DEFVAR_INT ("__" ## name ## "__", X ## sname, defn, 0, 1, 0, doc)
