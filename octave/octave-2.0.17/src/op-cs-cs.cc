...
lt (const octave_value& a1, const octave_value& a2)
{
  ...
  return (double) (real (v1.complex_value ()) < real (v2.complex_value ()));
}
...
eq (const octave_value& a1, const octave_value& a2)
{
  ...
  return (double) (v1.complex_value () == v2.complex_value ());
}
...
el_and (const octave_value& a1, const octave_value& a2)
{
  ...
  return (double) (v1.complex_value () != 0.0 && v2.complex_value () != 0.0);
}
