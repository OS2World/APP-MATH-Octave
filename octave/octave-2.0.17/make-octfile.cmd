...
if (octave_home == '') then
  do
    ...
    if (octave_home == '') then octave_home = "j:/apps2/science/octave";
  end

gccopt2 = '-m486 -mieee-fp -O3 -malign-loops=2 -malign-jumps=2 -malign-functions=2 -DEMX09C -DOS2';

lnkopt2 = '-lcruft1 -lcruft2 -lcruft3 -lcruft4 -loctave1 -loctave2 -lreadline -lgnuinfo -lkpathsea -lmerlin -lgpp2 -lstdcpp2 -lsocket -lf2cdll -loct-img' libs;
...
'@echo DESCRIPTION ' || d2c(34) || name || '.oct, (c) Klaus Gebhardt 1995-1997' || d2c(34) || '>>' name || '.def'
'@echo.>>' name || '.def'
'@echo DATA>>' name || '.def'
...
'gcc' gccopt2 '-o' name || '.oct' name || '.def' name || '.obj' lnkopt2 '-Zdll -Zomf -Zcrtdll'
